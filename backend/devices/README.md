...
```json
{
  ...
  "protocol": "mqtt",
  "payload": {
    "topic": "device/sensors/weather_publisher_5096/LON/temperature",
    "message": {
      "client_id": "weather_publisher_5096",
      "location": "LON",
      "temperature": 7.3,
      "unit": "°C",
      "measured_at": "2026-04-14T09:09:24.124861"
    }
  },
  "received_at": {
    "$date": "2026-04-14T09:09:24.129Z"
  }
}
```
